...
#parser.add_argument('--model_denoiser', default='models/GAN_discriminator_5.pth', help='pretrained denoising model')
#parser.add_argument('--model_SR', default='models/GAN_generator_5_module.pth', help='pretrained SR model')
