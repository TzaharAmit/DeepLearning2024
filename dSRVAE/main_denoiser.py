...
parser.add_argument('--data_dir', type=str, default='/home/linuxu/Desktop/project_dSRVAE/dSRVAE/data')
...
parser.add_argument('--pretrained_sr', default='VAE_SR.pth', help='sr pretrained base model')
parser.add_argument('--pretrained', type=bool, default=False)
parser.add_argument('--save_folder', default='/home/linuxu/Desktop/project_dSRVAE/dSRVAE/models/', help='Location to save checkpoint models')
parser.add_argument('--log_folder', default='/home/linuxu/Desktop/project_dSRVAE/dSRVAE/logs/', help='Location to save checkpoint models')
